<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto space-y-10">
        ...
        <div class="flex flex-wrap gap-6">
            <div
                class="bg-blue-100 p-6 rounded-lg flex items-center flex-1 min-w-[250px] hover:bg-gray-50 hover:ring-2 hover:ring-blue-100 transition-all border border-gray-200">
            ...
            <div
                class="bg-green-100 p-6 rounded-lg flex items-center flex-1 min-w-[250px] hover:bg-gray-50 hover:ring-2 hover:ring-blue-100 transition-all border border-gray-200">
            ...
            <div
                class="bg-yellow-100 p-6 rounded-lg flex items-center flex-1 min-w-[250px] hover:bg-gray-50 hover:ring-2 hover:ring-blue-100 transition-all border border-gray-200">
            ...
            <div
                class="bg-purple-100 p-6 rounded-lg flex items-center flex-1 min-w-[250px] hover:bg-gray-50 hover:ring-2 hover:ring-blue-100 transition-all border border-gray-200">
