<x-guest-layout>
    <div class="login-card">
        ...
        <div class="text-center mb-4">
            <h2 class="text-2xl fw-bold text-gray-800">Login Guru</h2>
        </div>
    ...
    <div class="info-box">
        ...
        <ul class="mb-0 ps-3">
            <li>Gunakan username atau email yang terdaftar sebagai guru.</li>
            <li>Hubungi admin jika Anda mengalami kendala saat login.</li>
            <li>Absensi dan pengelolaan data hanya tersedia pada waktu tertentu.</li>
        </ul>
    </div>
</x-guest-layout>
