        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center">
            ...
            <div class="absolute top-0 right-0 p-6 text-right">
                @auth
                    ...
                    <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 mr-4">Dashboard</a>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8 text-center">
                <div class="flex justify-center">
                    ...
                    <svg class="h-16 w-auto text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="mt-10">
                    <a href="{{ Auth::check() ? url('/dashboard') : route('login') }}" class="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300">
                        Mulai
                    </a>
                </div>
            </div>
